...
!function (e, define) {
    ...
    !function (e, t, r) {
        function n(e, a) {
            ...
            if (e = e.toLowerCase(), f = o.exec(e))return e = "transparent" == f[1] ? new u(1, 1, 1, 0) : n(h.namedColors[f[1]], a), e.match = [f[1]], e;
            if ((f = /^#?([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})\b/i.exec(e)) ? i = new l(r(f[1], 16), r(f[2], 16), r(f[3], 16), 1) : (f = /^#?([0-9a-f])([0-9a-f])([0-9a-f])\b/i.exec(e)) ? i = new l(r(f[1] + f[1], 16), r(f[2] + f[2], 16), r(f[3] + f[3], 16), 1) : (f = /^rgb\(\s*([0-9]+)\s*,\s*([0-9]+)\s*,\s*([0-9]+)\s*\)/.exec(e)) ? i = new l(r(f[1], 10), r(f[2], 10), r(f[3], 10), 1) : (f = /^rgba\(\s*([0-9]+)\s*,\s*([0-9]+)\s*,\s*([0-9]+)\s*,\s*([0-9.]+)\s*\)/.exec(e)) ? i = new l(r(f[1], 10), r(f[2], 10), r(f[3], 10), t(f[4])) : (f = /^rgb\(\s*([0-9]*\.?[0-9]+)%\s*,\s*([0-9]*\.?[0-9]+)%\s*,\s*([0-9]*\.?[0-9]+)%\s*\)/.exec(e)) ? i = new u(t(f[1]) / 100, t(f[2]) / 100, t(f[3]) / 100, 1) : (f = /^rgba\(\s*([0-9]*\.?[0-9]+)%\s*,\s*([0-9]*\.?[0-9]+)%\s*,\s*([0-9]*\.?[0-9]+)%\s*,\s*([0-9.]+)\s*\)/.exec(e)) && (i = new u(t(f[1]) / 100, t(f[2]) / 100, t(f[3]) / 100, t(f[4]))), i)i.match = f; else if (!a)throw Error("Cannot parse color: " + e);
            return i
        }
        ...
        var o, i, s, u, l, d, c, h = function (e) {
            var t, r, n, a, f, o = this, i = h.formats;
            if (1 === arguments.length)for (e = o.resolveColor(e), a = 0; i.length > a; a++)t = i[a].re, r = i[a].process, n = t.exec(e), n && (f = r(n), o.r = f[0], o.g = f[1], o.b = f[2]); else o.r = arguments[0], o.g = arguments[1], o.b = arguments[2];
            o.r = o.normalizeByte(o.r), o.g = o.normalizeByte(o.g), o.b = o.normalizeByte(o.b)
        };
        h.prototype = {
            toHex: function () {
                var e = this, t = e.padDigit, r = e.r.toString(16), n = e.g.toString(16), a = e.b.toString(16);
                return "#" + t(r) + t(n) + t(a)
        ...
        o = RegExp("^(" + o.join("|") + ")(\\W|$)", "i"), s = kendo.Class.extend({
            ...
            init: function (e, t, r, n) {
                ...
                var e, t, r = this.r, n = this.g, a = this.b, f = Math.min(r, n, a), o = Math.max(r, n, a), i = o, s = o - f;
                return 0 === s ? new d(0, 0, i, this.a) : (0 !== o ? (t = s / o, e = r == o ? (n - a) / s : n == o ? 2 + (a - r) / s : 4 + (r - n) / s, e *= 60, 0 > e && (e += 360)) : (t = 0, e = -1), new d(e, t, i, this.a))
            }, toHSL: function () {
                var e, t, r, n = this.r, a = this.g, f = this.b, o = Math.max(n, a, f), i = Math.min(n, a, f), s = (o + i) / 2;
                if (o == i)e = t = 0; else {
            ...
            init: function (e, t, r, n) {
                ...
                var e, t, r, n, a, f, o, i, s = this.h, l = this.s, d = this.v;
                if (0 === l)t = r = n = d; else switch (s /= 60, e = Math.floor(s), a = s - e, f = d * (1 - l), o = d * (1 - l * a), i = d * (1 - l * (1 - a)), e) {
                    case 0:
                        t = d, r = i, n = f;
                        break;
                    case 1:
            ...
            init: function (e, t, r, n) {
                ...
                var e, t, r, n, a, o = this.h, i = this.s, s = this.l;
                return 0 === i ? e = t = r = s : (o /= 360, i /= 100, s /= 100, n = .5 > s ? s * (1 + i) : s + i - s * i, a = 2 * s - n, e = f(a, n, o + 1 / 3), t = f(a, n, o), r = f(a, n, o - 1 / 3)), new u(e, t, r, this.a)
            }, toHSV: function () {
                return this.toRGB().toHSV()
            }, toBytes: function () {
                return this.toRGB().toBytes()
