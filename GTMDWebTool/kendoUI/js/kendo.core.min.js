...
!function (e, define) {
    ...
    return function (e, t, n) {
        ...
        ye.version = "2016.2.607".replace(/^\s+|\s+$/g, ""), r.extend = function (e) {
            var t, n, r = function () {
            ...
            function u(e, r, a) {
                if (!e)return null;
                var u, l, c, d, p, h, g, v, b, w, M, S, T, x = function (e) {
                    for (var t = 0; r[F] === e;)t++, F++;
                    return t > 0 && (F -= 1), t
                }, k = function (t) {
                    var n = y[t] || RegExp("^\\d{1," + t + "}"), r = e.substr(R, t).match(n);
                ...
                for (r || (r = "d"), d = D.patterns[r], d && (r = d), r = r.split(""), c = r.length; c > F; F++)if (u = r[F], U)"'" === u ? U = !1 : z(); else if ("d" === u) {
                    ...
                    if (l = x("f"), T = e.substr(R, l).match(y[3]), P = k(l), null !== P && (P = parseFloat("0." + T[0], 10), P = ye._round(P, 3), P *= 1e3), null === P || t(P, 0, 999))return null
                } else if ("t" === u) {
                    if (l = x("t"), v = D.AM, b = D.PM, 1 === l && (v = o(v), b = o(b)), p = O(b), !p && !O(v))return null
                } else if ("z" === u) {
                    if (h = !0, l = x("z"), "Z" === e.substr(R, 1)) {
                        z();
                        continue
                    }
                    if (g = e.substr(R, 6).match(l > 2 ? m : f), !g)return null;
                ...
                return S = null !== A || null !== _ || N || null, null === C && null === E && null === H && S ? (C = L, E = I.getMonth(), H = I.getDate()) : (null === C && (C = L), null === H && (H = 1)), p && 12 > A && (A += 12), h ? (w && (A += -w), M && (_ += -M), e = new Date(Date.UTC(C, E, H, A, _, N, P))) : (e = new Date(C, E, H, A, _, N, P), i(e, A)), 100 > C && e.setFullYear(C), e.getDate() !== H && h === n ? null : e
            }
            ...
            Widget: X, DataBoundWidget: ee, roles: {}, progress: function (t, n) {
            ...
            setupMouseMute: function () {
                ...
                if (!le.mouseTrap && ke.eventCapture)for (le.mouseTrap = !0, le.bustClick = !1, le.captureMouse = !1, t = function (t) {
                    le.captureMouse && ("click" === t.type ? le.bustClick && !e(t.target).is(ue) && (t.preventDefault(), t.stopPropagation()) : t.stopPropagation())
                }; r > n; n++)o.addEventListener(se[n], t, !0)
            ...
            }, !1); t.nextNode();)t.referenceNode && !t.referenceNode.textContent.trim() && t.referenceNode.parentNode.removeChild(t.referenceNode); else for (n = 0; e.childNodes.length > n; n++)r = e.childNodes[n], 3 != r.nodeType || /\S/.test(r.nodeValue) || (e.removeChild(r), n--), 1 == r.nodeType && ye.stripWhitespace(r)
            ...
            function n(t, n, r, o) {
                var i, a, s = e("<form>").attr({action: r, method: "POST", target: o}), u = ye.antiForgeryTokens();
