...
!function (e) {
    ...
    !function (e, t) {
        kendo.ui.FilterCell && (kendo.ui.FilterCell.prototype.options.operators = e.extend(!0, kendo.ui.FilterCell.prototype.options.operators, {
            ...
            enums: {eq: "հավասար է", neq: "հավասար չէ"}
            ...
            frequencies: {daily: "Օրական", monthly: "Ամսական", never: "Երբեք", weekly: "Շաբաթական", yearly: "Տարեկան"},
            monthly: {day: "Օր", interval: "ամիս(ներ)", repeatEvery: "Կրկնել ամեն:", repeatOn: "Կրկնել:"},
            offsetPositions: {first: "առաջին", fourth: "չորրորդ", last: "վերջին", second: "երկրորդ", third: "երրորդ"},
            weekly: {repeatEvery: "Կրկնել ամեն:", repeatOn: "Կրկնել:", interval: "շաբաթ(ներ)"},
            yearly: {of: "of", repeatEvery: "Կրկնել ամեն:", repeatOn: "Կրկնել:", interval: "տարի(ներ)"},
            weekdays: {day: "օր", weekday: "աշխատանքային օր", weekend: "ոչ աշխատանքային օր"}
            ...
            editable: {confirmation: "Հեռացնե՞լ նշված տողը։", cancelDelete: "Չեղարկել", confirmDelete: "Հեռացնել"},
            ...
            allDay: "ամեն օր",
            cancel: "Չեղարկել",
            editable: {confirmation: "Ցանկանու՞մ եք հեռացնել։"},
            date: "Ամսաթիվ",
            destroy: "Հեռացնել",
            editor: {
