...
!function (e) {
    ...
    !function (e, t) {
        kendo.ui.FilterCell && (kendo.ui.FilterCell.prototype.options.operators = e.extend(!0, kendo.ui.FilterCell.prototype.options.operators, {
            ...
            enums: {eq: "Er lig med", neq: "Er ikke lig med"}
        })), kendo.ui.FilterMultiCheck && (kendo.ui.FilterMultiCheck.prototype.options.messages = e.extend(!0, kendo.ui.FilterMultiCheck.prototype.options.messages, {search: "Søg"})), kendo.ui.ColumnMenu && (kendo.ui.ColumnMenu.prototype.options.messages = e.extend(!0, kendo.ui.ColumnMenu.prototype.options.messages, {
            columns: "Кolonner",
            ...
            frequencies: {daily: "Daglig", monthly: "Månedlig", never: "Aldrig", weekly: "Ugentlig", yearly: "Årlig"},
            monthly: {day: "Dag", interval: "måned(er)", repeatEvery: "Gentag hver:", repeatOn: "Gentag den:"},
            offsetPositions: {first: "første", fourth: "fjerde", last: "sidste", second: "anden", third: "tredje"},
            weekly: {repeatEvery: "Gentag hver:", repeatOn: "Gentag den:", interval: "uge(r)"},
            yearly: {of: "of", repeatEvery: "Gentag hvert:", repeatOn: "Gentag den:", interval: "år"},
            weekdays: {day: "dag", weekday: "ugedag", weekend: "weekend dag"}
            ...
            allDay: "hele dagen",
            cancel: "Fortryd",
            editable: {confirmation: "Er du sikker på at du vil slette denne begivenhed?"},
            date: "Dato",
            destroy: "Slet",
            editor: {
