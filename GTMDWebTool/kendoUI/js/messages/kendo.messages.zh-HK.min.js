...
!function (e) {
    ...
    !function (e, t) {
        kendo.ui.FlatColorPicker && (kendo.ui.FlatColorPicker.prototype.options.messages = e.extend(!0, kendo.ui.FlatColorPicker.prototype.options.messages, {
            ...
            remove: "移除",
            okText: "是",
            formatCellsDialog: {title: "格式", categories: {number: "數字", currency: "貨幣", date: "日期"}},
            fontFamilyDialog: {title: "字體"},
            fontSizeDialog: {title: "字體大小"},
            bordersDialog: {title: "邊框"},
            alignmentDialog: {
                title: "對齊",
                buttons: {
                    justtifyLeft: "向左對齊",
            ...
            mergeDialog: {
                title: "合併儲存格",
                buttons: {mergeCells: "全部合併", mergeHorizontally: "水平合併", mergeVertically: "垂直合併", unmerge: "取消合併"}
            },
            freezeDialog: {
                title: "鎖定儲存格",
                buttons: {freezePanes: "鎖定儲存格", freezeRows: "鎖定行", freezeColumns: "鎖定列", unfreeze: "取消鎖定儲存格"}
            },
            validationDialog: {
                title: "數據驗證",
                hintMessage: "請輪入有效的 {0} 數值 {1}.",
                hintTitle: "驗證 {0}",
                criteria: {any: "任何數值", number: "數字", text: "文字", date: "日期", custom: "自訂公式", list: "列表"},
                comparers: {
                    greaterThan: "大於",
                    lessThan: "小於",
                    between: "在 ... 之間",
                ...
                placeholders: {typeTitle: "種類標題", typeMessage: "種類訊息"}
            },
            saveAsDialog: {title: "另存...", labels: {fileName: "檔案名稱", saveAsType: "另存種類"}},
            exportAsDialog: {
                title: "滙出...",
                labels: {
                    fileName: "檔案名稱",
            ...
            modifyMergedDialog: {errorMessage: "不能轉換部份已合併的儲存格"},
            useKeyboardDialog: {
            ...
            }, tabs: {home: "主頁", insert: "插入", data: "資料"}
        }))
    }(window.kendo.jQuery)
});
