...
!function (e) {
    ...
    !function (e, o) {
        kendo.ui.FilterCell && (kendo.ui.FilterCell.prototype.options.operators = e.extend(!0, kendo.ui.FilterCell.prototype.options.operators, {
            ...
            enums: {eq: "È uguale a", neq: "Non è uguale a", isnull: "È nullo", isnotnull: "Non è nullo"}
            ...
            operator: "Operatore",
            value: "Valore"
        })), kendo.ui.FilterMultiCheck && (kendo.ui.FilterMultiCheck.prototype.options.messages = e.extend(!0, kendo.ui.FilterMultiCheck.prototype.options.messages, {search: "Cerca"})), kendo.ui.Grid && (kendo.ui.Grid.prototype.options.messages = e.extend(!0, kendo.ui.Grid.prototype.options.messages, {
            commands: {
                canceledit: "Annulla",
    ...
    }(window.kendo.jQuery), kendo.spreadsheet && kendo.spreadsheet.messages.borderPalette && (kendo.spreadsheet.messages.borderPalette = $.extend(!0, kendo.spreadsheet.messages.borderPalette, {
    ...
    })), kendo.spreadsheet && kendo.spreadsheet.messages.dialogs && (kendo.spreadsheet.messages.dialogs = $.extend(!0, kendo.spreadsheet.messages.dialogs, {
        apply: "Applica",
        save: "Salva",
        cancel: "Annulla",
        remove: "Rimuovi",
        okText: "OK",
        formatCellsDialog: {title: "Formato", categories: {number: "Numero", currency: "Valuta", date: "Data"}},
        fontFamilyDialog: {title: "Carattere"},
        fontSizeDialog: {title: "Dimensione carattere"},
        bordersDialog: {title: "Bordi"},
        alignmentDialog: {
            title: "Allineamento",
            buttons: {
        ...
        validationDialog: {
            ...
            placeholders: {typeTitle: "Tipo di titolo", typeMessage: "Tipo di messaggio"}
        },
        saveAsDialog: {title: "Salva con nome...", labels: {fileName: "Nome file", saveAsType: "Salva come tipo"}},
        modifyMergedDialog: {errorMessage: "Impossibile modificare parte di una cella unita."},
        useKeyboardDialog: {
            ...
            labels: {forCopy: "per copiare", forCut: "per tagliare", forPaste: "per incollare"}
        },
        unsupportedSelectionDialog: {errorMessage: "L'azione non può essere eseguita su selezione multipla."}
    })), kendo.spreadsheet && kendo.spreadsheet.messages.filterMenu && (kendo.spreadsheet.messages.filterMenu = $.extend(!0, kendo.spreadsheet.messages.filterMenu, {
        ...
        operators: {
            ...
            date: {eq: "È uguale a", neq: "Non è uguale a", lt: "È prima", gt: "È dopo"},
            number: {
                eq: "È uguale a",
                gt: "È più grande di",
                gte: "È più grande o uguale a",
    ...
    })), kendo.spreadsheet && kendo.spreadsheet.messages.toolbar && (kendo.spreadsheet.messages.toolbar = $.extend(!0, kendo.spreadsheet.messages.toolbar, {
        addColumnLeft: "Aggiungi colonna a sinistra",
        addColumnRight: "Aggiungi colonna a destra",
        addRowAbove: "Aggiungi riga sopra",
        addRowBelow: "Aggiungi riga sotto",
        ...
        open: "Apri...",
        paste: "Incolla",
        quickAccess: {redo: "Ripristina", undo: "Annulla"},
    ...
    })), kendo.spreadsheet && kendo.spreadsheet.messages.view && (kendo.spreadsheet.messages.view = $.extend(!0, kendo.spreadsheet.messages.view, {
        errors: {
        ...
        }, tabs: {home: "Home", insert: "Inserisci", data: "Dati"}
    }))
});
