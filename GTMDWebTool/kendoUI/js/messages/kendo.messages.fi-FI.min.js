...
!function (e) {
    ...
    !function (e, t) {
        kendo.ui.FlatColorPicker && (kendo.ui.FlatColorPicker.prototype.options.messages = e.extend(!0, kendo.ui.FlatColorPicker.prototype.options.messages, {
            ...
            save: "Tallenna",
            views: {day: "Päivä", end: "Loppu", month: "Kuukausi", start: "Alku", week: "Viikko", year: "Vuosi"}
            ...
            hourly: {repeatEvery: "Toista joka: ", interval: " tunti"},
            daily: {repeatEvery: "Toista joka: ", interval: " päivä"},
            weekly: {interval: " viikko", repeatEvery: "Toista joka: ", repeatOn: "Toista tällöin: "},
            monthly: {repeatEvery: "Toista joka: ", repeatOn: "Toista tällöin: ", interval: " kuukausi", day: "Päivä "},
            yearly: {repeatEvery: "Toista joka: ", repeatOn: "Toista tällöin: ", interval: " vuosi", of: " kk: "},
            end: {
                label: "Loppu:",
                mobileLabel: "Loppuu",
                never: "Ei koskaan",
            ...
            weekdays: {day: "päivä", weekday: "arkipäivä", weekend: "viikonloppu"}
            ...
            editable: {confirmation: "Haluatko varmasti poistaa tapahtuman?"},
            views: {day: "Päivä", week: "Viikko", workWeek: "Työviikko", agenda: "Agenda", month: "Kuukausi"},
            recurrenceMessages: {
            ...
            formatCellsDialog: {
                title: "Muotoilu",
                categories: {number: "Numero", currency: "Valuutta", date: "Päivämäärä"}
            },
            fontFamilyDialog: {title: "Fontti"},
            fontSizeDialog: {title: "Fonttikoko"},
            bordersDialog: {title: "Reunaviivat"},
            alignmentDialog: {
                title: "Asemointi",
                buttons: {
            ...
            validationDialog: {
                ...
                placeholders: {typeTitle: "Tyypin otsikko", typeMessage: "Tyypin viesti"}
            },
            saveAsDialog: {
                title: "Tallenna nimellä...",
                labels: {fileName: "Tiedostonimi", saveAsType: "Tiedoston tyyppi"}
            },
            modifyMergedDialog: {errorMessage: "Yhdistetyn solun osaa ei voi muuttaa."},
            useKeyboardDialog: {
                title: "Kopiointi ja liittäminen",
                errorMessage: "Näitä toimintoja ei voi käyttää valikosta. Käytä näppäinoikoteitä:",
                labels: {forCopy: "kopioidaksesi", forCut: "leikataksesi", forPaste: "liittääksesi"}
            },
            unsupportedSelectionDialog: {errorMessage: "Toimintoa ei voi suorittaa useille kohteille."}
            ...
            open: "Avaa...",
            paste: "Liitä",
            quickAccess: {redo: "Tee uudelleen", undo: "Kumoa"},
            ...
            }, tabs: {home: "Aloitus", insert: "Lisää", data: "Data"}
