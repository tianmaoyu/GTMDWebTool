...
!function (e) {
    ...
    !function (e, t) {
        kendo.ui.Validator && (kendo.ui.Validator.prototype.options.messages = e.extend(!0, kendo.ui.Validator.prototype.options.messages, {
            ...
            formatCellsDialog: {title: "Форматиране", categories: {number: "Число", currency: "Валута", date: "Дата"}},
            fontFamilyDialog: {title: "Шрифт"},
            fontSizeDialog: {title: "Размер на шрифта"},
            bordersDialog: {title: "Граници"},
            alignmentDialog: {
                title: "Подравняване",
                buttons: {
            ...
            validationDialog: {
                ...
                criteria: {any: "Всяка стойност", number: "Число", text: "Текст", date: "Дата", custom: "По избор"},
                comparers: {
                ...
                placeholders: {typeTitle: "Напишете заглавие", typeMessage: "Напишете съобщение"}
            },
            saveAsDialog: {title: "Запиши като...", labels: {fileName: "Име на файл", saveAsType: "Запиши като"}},
            modifyMergedDialog: {errorMessage: "Не може да се промени част от обединена клетка."},
            useKeyboardDialog: {
                ...
                labels: {forCopy: "за копиране", forCut: "за изрязване", forPaste: "за поставяне"}
            },
            unsupportedSelectionDialog: {errorMessage: "Командата, която сте избрали, не може да бъде използвана с няколко селекции."}
            ...
            operators: {
                ...
                date: {eq: "Е равно на", neq: "Не е равно на", lt: "Е преди", gt: "Е след"},
                number: {
                    eq: "Е равно на",
                    neq: "Не е равно на",
            ...
            open: "Отвори...",
            paste: "Поставяне",
            quickAccess: {redo: "Стъпка напред", undo: "Стъпка назад"},
            saveAs: "Запиши като...",
            ...
            errors: {shiftingNonblankCells: "Не може да се вмъкнат клетки поради възможност от загуба на данни. Изберете друга локация за вмъкване на клетки или изтрийте данни от края на работния лист."},
            tabs: {home: "Начало", insert: "Вмъкване", data: "Данни"}
        ...
        })), kendo.ui.progress && (kendo.ui.progress.messages = e.extend(!0, kendo.ui.progress.messages, {loading: "Зареждане..."}))
    }(window.kendo.jQuery)
});
