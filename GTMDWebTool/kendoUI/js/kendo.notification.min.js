...
!function (t, define) {
    ...
    return function (t, i) {
        var n = window.kendo, e = n.ui.Widget, o = t.proxy, a = t.extend, s = window.setTimeout, p = "click", d = "show", c = "hide", l = "k-notification", u = ".k-notification-wrap .k-i-close", r = "k-hiding", f = "info", h = "success", g = "warning", m = "error", _ = "top", w = "left", k = "bottom", v = "right", P = "up", T = ".kendoNotification", b = '<div class="k-widget k-notification"></div>', C = '<div class="k-notification-wrap"><span class="k-icon k-i-note">#=typeIcon#</span>#=content#<span class="k-icon k-i-close">Hide</span></div>', y = C.replace("#=content#", "#:content#"), S = e.extend({
            init: function (i, o) {
                var a = this;
            ...
            _attachPopupEvents: function (t, i) {
                ...
                var o, a = this, d = t.allowHideAfter, c = !isNaN(d) && d > 0;
                i.options.anchor !== document.body && i.options.origin.indexOf(v) > 0 && i.bind("open", function () {
                    var t = n.getShadows(i.element);
                    s(function () {
                        i.wrapper.css("left", parseFloat(i.wrapper.css("left")) + t.left + t.right)
                    })
                }), t.hideOnClick ? i.bind("activate", function () {
                    c ? s(function () {
                        e(i.element)
                    }, d) : e(i.element)
                }) : t.button && (o = i.element.find(u), c ? s(function () {
                    e(o)
                }, d) : e(o))
            },
            _showPopup: function (i, e) {
                var o, p, d = this, c = e.autoHideAfter, l = e.position.left, f = e.position.top;
            ...
            _attachStaticEvents: function (t, i) {
                ...
                var e = this, a = t.allowHideAfter, d = !isNaN(a) && a > 0;
            ...
            _showStatic: function (t, i) {
                var n = this, e = i.autoHideAfter, o = i.animation, a = i.stacking == P || i.stacking == w ? "prependTo" : "appendTo";
                t.addClass(n._guid)[a](i.appendTo).hide().kendoAnimate(o.open || !1), n._attachStaticEvents(i, t), e > 0 && s(function () {
                    n._hideStatic(t)
                }, e)
            },
            ...
            _triggerHide: function (t) {
                this.trigger(c, {element: t}), this.angular("cleanup", function () {
                    return {elements: t}
                })
            },
            show: function (e, o, s) {
                var p, c, u = this, r = u.options, h = t(b);
                return o || (o = f), null !== e && e !== i && "" !== e && (n.isFunction(e) && (e = e()), c = {
                    typeIcon: o,
                    content: ""
                }, p = t.isPlainObject(e) ? a(c, e) : a(c, {content: e}), h.addClass(l + "-" + o).toggleClass(l + "-button", r.button).attr("data-role", "alert").css({
                    width: r.width,
                    height: r.height
                }).append(u._getCompiled(o, s)(p)), u.angular("compile", function () {
                    return {elements: h, data: [{dataItem: p}]}
                }), t(r.appendTo)[0] ? u._showStatic(h, r) : u._showPopup(h, r), u.trigger(d, {element: h})), u
            },
            ...
            hide: function () {
                var i = this, n = i.getNotifications();
