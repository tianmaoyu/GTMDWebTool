...
!function (e, define) {
    ...
    return function (e, t) {
        var a = window.kendo, n = "change", i = "cancel", r = "dataBound", l = "dataBinding", o = a.ui.Widget, s = a.keys, d = ">*:not(.k-loading-mask)", c = "progress", u = "error", m = "k-state-focused", f = "k-state-selected", p = "k-edit-item", g = "edit", h = "remove", _ = "save", v = "click", b = ".kendoListView", S = e.proxy, E = a._activeElement, w = a.ui.progress, k = a.data.DataSource, y = a.ui.DataBoundWidget.extend({
            init: function (t, n) {
                var i = this;
                n = e.isArray(n) ? {dataSource: n} : n, o.fn.init.call(i, t, n), n = i.options, i.wrapper = t = i.element, t[0].id && (i._itemId = t[0].id + "_lv_active"), i._element(), i._dataSource(), i._templates(), i._navigatable(), i._selectable(), i._pageable(), i._crudHandlers(), i.options.autoBind && i.dataSource.fetch(), a.notify(i)
            },
            ...
            dataItem: function (t) {
                var n = a.attr("uid"), i = e(t).closest("[" + n + "]").attr(n);
            ...
            refresh: function (e) {
                var n, i, o, s, d, c = this, u = c.dataSource.view(), m = "", f = c.template, p = c.altTemplate, g = E();
                if (e = e || {}, "itemchange" === e.action)return c._hasBindingTarget() || c.editable || (n = e.items[0], o = c.items().filter("[" + a.attr("uid") + "=" + n.uid + "]"), o.length > 0 && (s = o.index(), c.angular("cleanup", function () {
                    ...
                    return {elements: [o], data: [{dataItem: n}]}
                }), c.trigger("itemChange", {item: o, data: n}))), t;
                if (!c.trigger(l, {action: e.action || "rebind", items: e.items, index: e.index})) {
                    for (c._angularItems("cleanup"), c._destroyEditable(), s = 0, d = u.length; d > s; s++)m += s % 2 ? p(u[s]) : f(u[s]);
                    for (c.element.html(m), i = c.items(), s = 0, d = u.length; d > s; s++)i.eq(s).attr(a.attr("uid"), u[s].uid).attr("role", "option").attr("aria-selected", "false");
                    c.element[0] === g && c.options.navigatable && c.current(i.eq(0)), c._angularItems("compile"), c.trigger(r)
                }
            },
            _pageable: function () {
                var t, n, i = this, r = i.options.pageable;
            ...
            _selectable: function () {
                ...
                l && (e = a.ui.Selectable.parseOptions(l).multiple, r.selectable = new a.ui.Selectable(r.element, {
                    ...
                    if (a.keyCode === s.SPACEBAR) {
                        if (i = r.current(), a.target == a.currentTarget && a.preventDefault(), e)if (a.ctrlKey) {
            ...
            current: function (e) {
                var a = this, n = a.element, i = a._current, r = a._itemId;
            ...
            _scrollTo: function (t) {
                var a, n, i = this, r = !1, l = "scroll";
                "auto" == i.wrapper.css("overflow") || i.wrapper.css("overflow") == l ? a = i.wrapper[0] : (a = window, r = !0), n = function (n, i) {
                    var o = r ? e(t).offset()[n.toLowerCase()] : t["offset" + n], s = t["client" + i], d = e(a)[l + n](), c = e(a)[i.toLowerCase()]();
                    o + s > d + c ? e(a)[l + n](o + s - c) : d > o && e(a)[l + n](o)
                }, n("Top", "Height"), n("Left", "Width")
            },
            _navigatable: function () {
                var t = this, n = t.options.navigatable, i = t.element, r = function (a) {
                ...
                n && (t._tabindex(), i.on("focus" + b, function () {
                    ...
                    var r, l, o = n.keyCode, d = t.current(), c = e(n.target), u = !c.is(":button,textarea,a,a>.t-icon,input"), m = c.is(":text,:password"), f = a.preventDefault, g = i.find("." + p), h = E();
            ...
            _closeEditable: function () {
                var e, t, n, i = this, r = i.editable, l = i.template;
            ...
            edit: function (e) {
                var t, n, i = this, r = i._modelFromElement(e), l = r.uid;
                i.cancel(), e = i.items().filter("[" + a.attr("uid") + "=" + l + "]"), n = e.index(), e.replaceWith(i.editTemplate(r)), t = i.items().eq(n).addClass(p).attr(a.attr("uid"), r.uid), i.editable = t.kendoEditable({
                    ...
                    errorTemplate: !1,
                    target: i
                }).data("kendoEditable"), i.trigger(g, {model: r, item: t})
            },
            save: function () {
                var e, t, a = this, n = a.editable;
            ...
            remove: function (e) {
                var t = this, a = t.dataSource, n = t._modelFromElement(e);
            ...
            add: function () {
                var e, t = this, a = t.dataSource, n = a.indexOf((a.view() || [])[0]);
                0 > n && (n = 0), t.cancel(), e = a.insert(n, {}), t.edit(t.element.find("[data-uid='" + e.uid + "']"))
            },
            cancel: function () {
                var e, t, a = this, n = a.dataSource;
