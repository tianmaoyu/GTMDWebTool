...
!function (e, define) {
    ...
    return function (e, t) {
        function n(e, t) {
            ...
            return n.right = n.left + e.outerWidth(), n.bottom = n.top + e.outerHeight(), !(n.left > i || t.left > n.right || n.top > l || t.top > n.bottom)
        }

        var i, s = window.kendo, l = s.ui.Widget, a = e.proxy, o = Math.abs, r = "aria-selected", c = "k-state-selected", u = "k-state-selecting", d = "k-selectable", f = "change", v = ".kendoSelectable", m = "k-state-unselecting", h = "input,a,textarea,.k-multiselect-wrap,select,button,.k-button>span,.k-button>img,span.k-icon.k-i-expand,span.k-icon.k-i-collapse", p = s.support.browser.msie, _ = !1;
        !function (e) {
            !function () {
            ...
            _isElement: function (e) {
                var t, n = this.element, i = n.length, s = !1;
            ...
            _start: function (n) {
                var i, s = this, l = e(n.target), a = l.hasClass(c), o = n.event.ctrlKey || n.event.metaKey;
            ...
            _invalidateSelectables: function (e, t) {
                var i, s, l, a, o = this._downTarget[0], r = this._items;
                for (i = 0, s = r.length; s > i; i++)a = r.eq(i), l = a.add(this.relatedTarget(a)), n(a, e) ? a.hasClass(c) ? t && o !== a[0] && l.removeClass(c).addClass(m) : a.hasClass(u) || a.hasClass(m) || l.addClass(u) : a.hasClass(u) ? l.removeClass(u) : t && a.hasClass(m) && l.removeClass(m).addClass(c)
            },
            value: function (e) {
            ...
            _allowSelection: function (t) {
                return e(t).is(h) ? (this.userEvents.cancel(), this._downTarget = null, !1) : !0
            },
            ...
            selectRange: function (t, n) {
                var i, s, l, a = this;
                for (a.clear(), a.element.length > 1 && (l = a.options.continuousItems()), l && l.length || (l = a.element.find(a.options.filter)), t = e.inArray(e(t)[0], l), n = e.inArray(e(n)[0], l), t > n && (s = t, t = n, n = s), a.options.useAllItems || (n += a.element.length - 1), i = t; n >= i; i++)a._selectElement(l[i]);
                a._notify(f)
            },
            destroy: function () {
                var e = this;
