...
!function (t, define) {
    ...
    return function (t, e) {
        function n(t, e, n, a) {
            var r, i = t.getFullYear(), o = e.getFullYear(), s = n.getFullYear();
            return i -= i % a, r = i + (a - 1), o > i && (i = o), r > s && (r = s), i + "-" + r
        }

        function a(t) {
            for (var e, n = 0, a = t.min, r = t.max, i = t.start, o = t.setter, l = t.build, u = t.cells || 12, c = t.perRow || 4, f = t.content || H, d = t.empty || P, g = t.html || '<table tabindex="0" role="grid" class="k-content k-meta-view" cellspacing="0"><tbody><tr role="row">'; u > n; n++)n > 0 && n % c === 0 && (g += '</tr><tr role="row">'), i = new pt(i.getFullYear(), i.getMonth(), i.getDate(), 0, 0, 0), T(i, 0), e = l(i, n, t.disableDates), g += s(i, a, r) ? f(e) : d(e), o(i, 1);
        ...
        function g(t) {
            var n = wt[t.start], a = wt[t.depth], r = A(t.culture);
        ...
        function w(t) {
            var e, n = [];
            for (e = 0; t.length > e; e++)n.push(t[e].setHours(0, 0, 0, 0));
            return n
        }

        function D(e) {
            var n, a, r, i, o, s = [], l = ["su", "mo", "tu", "we", "th", "fr", "sa"], u = "if (found) { return true } else {return false}";
            if (e[0] instanceof pt)s = w(e), n = "var found = date && $.inArray(date.setHours(0, 0, 0, 0),[" + s + "]) > -1;" + u; else {
                for (r = 0; e.length > r; r++)i = e[r].slice(0, 2).toLowerCase(), o = t.inArray(i, l), o > -1 && s.push(o);
        ...
        var b, F = window.kendo, y = F.support, x = F.ui, Y = x.Widget, C = F.keys, M = F.parseDate, T = F.date.adjustDST, S = F._extractFormat, O = F.template, A = F.getCulture, V = F.support.transitions, N = V ? V.css + "transform-origin" : "", H = O('<td#=data.cssClass# role="gridcell"><a tabindex="-1" class="k-link" href="\\#" data-#=data.ns#value="#=data.dateString#">#=data.value#</a></td>', {useWithBlock: !1}), P = O('<td role="gridcell">&nbsp;</td>', {useWithBlock: !1}), E = F.support.browser, z = E.msie && 9 > E.version, I = ".kendoCalendar", B = "click" + I, W = "keydown" + I, R = "id", U = "min", j = "left", G = "slideIn", L = "month", q = "century", $ = "change", K = "navigate", Q = "value", J = "k-state-hover", X = "k-state-disabled", Z = "k-state-focused", tt = "k-other-month", et = ' class="' + tt + '"', nt = "k-nav-today", at = "td:has(.k-link)", rt = "blur" + I, it = "focus", ot = it + I, st = y.touch ? "touchstart" : "mouseenter", lt = y.touch ? "touchstart" + I : "mouseenter" + I, ut = y.touch ? "touchend" + I + " touchmove" + I : "mouseleave" + I, ct = 6e4, ft = 864e5, dt = "_prevArrow", gt = "_nextArrow", vt = "aria-disabled", ht = "aria-selected", _t = t.proxy, mt = t.extend, pt = Date, wt = {
            ...
            init: function (e, n) {
                ...
                Y.fn.init.call(s, e, n), e = s.wrapper = s.element, n = s.options, n.url = window.unescape(n.url), s.options.disableDates = p(s.options.disableDates), s._templates(), s._header(), s._footer(s.footer), r = e.addClass("k-widget k-calendar").on(lt + " " + ut, at, c).on(W, "table.k-content", _t(s._move, s)).on(B, at, function (e) {
                    var n = e.currentTarget.firstChild, a = s._toDateObject(n);
            ...
            options: {
                ...
                depth: L,
                animation: {
                    horizontal: {effects: G, reverse: !0, duration: 500, divisor: 2},
            ...
            navigateDown: function (t) {
                ...
                if (t)return a === wt[r] ? (k(n._value, n._current) && k(n._value, t) || (n.value(t), n.trigger($)), e) : (n.navigate(t, --a), e)
            },
            navigate: function (n, a) {
                var r, i, s, l, u, c, f, d, g, h, _, m, p, w, D, k, F;
            ...
            value: function (t) {
                var n = this, a = n._view, r = n.options, i = n._view, o = r.min, l = r.max;
                return t === e ? n._value : (null === t && (n._current = new Date(n._current.getFullYear(), n._current.getMonth(), n._current.getDate())), t = M(t, r.format, r.culture), null !== t && (t = new pt(+t), s(t, o, l) || (t = null)), n.options.disableDates(t) ? n._value === e && (n._value = null) : n._value = t, i && null === t && n._cell ? n._cell.removeClass("k-state-selected") : (n._changeView = !t || a && 0 !== a.compare(t, n._current), n.navigate(t)), e)
            },
            _move: function (e) {
                var n, a, r, i, l = this, u = l.options, c = e.keyCode, f = l._view, d = l._index, g = l.options.min, v = l.options.max, h = new pt(+l._current), _ = F.support.isRtl(l.wrapper), m = l.options.disableDates;
            ...
            _nextNavigatable: function (t, e) {
                var n = this, a = !0, r = n._view, i = n.options.min, o = n.options.max, l = n.options.disableDates, u = new Date(t.getTime());
                for (r.setDate(u, -e); a;) {
            ...
            _horizontal: function (t, e, n) {
                var a = this, r = a._active, i = a.options.animation.horizontal, o = i.effects, s = t.outerWidth();
            ...
            _vertical: function (t, e) {
                var n, a, r = this, i = r.options.animation.vertical, o = i.effects, s = r._active;
            ...
            _class: function (e, n) {
                var a, r = this, i = r._cellID, o = r._cell, s = r._view.toDateString(n);
            ...
            _click: function (t) {
                var e = this, n = e.options, a = new Date(+e._current), r = e._toDateObject(t);
            ...
            _footer: function (n) {
                var a = this, r = i(), o = a.element, s = o.find(".k-footer");
            ...
            _navigate: function (t, e) {
                var n = this, a = n._index + 1, r = new pt(+n._current);
            ...
            _toggle: function (t) {
                var n = this, a = n.options, r = n.options.disableDates(i()), o = n._today;
            ...
            _todayClick: function (t) {
                var e = this, n = wt[e.options.depth], a = e.options.disableDates, r = i();
        ...
        x.plugin(Dt), b = {
            firstDayOfMonth: function (t) {
                ...
                for (var n = e.firstDay, a = new pt(t.getFullYear(), t.getMonth(), 0, t.getHours(), t.getMinutes(), t.getSeconds(), t.getMilliseconds()); a.getDay() != n;)b.setTime(a, -1 * ft);
                return a
            }, setTime: function (t, e) {
                var n = t.getTimezoneOffset(), a = new pt(t.getTime() + e), r = a.getTimezoneOffset() - n;
                t.setTime(a.getTime() + r * ct)
            }, views: [{
                name: L, title: function (t, e, n, a) {
                    return d(a).months.names[t.getMonth()] + " " + t.getFullYear()
                }, content: function (t) {
                    for (var e = this, n = 0, r = t.min, i = t.max, o = t.date, s = t.dates, u = t.format, c = t.culture, f = t.url, g = f && s[0], v = d(c), _ = v.firstDay, m = v.days, p = l(m.names, _), w = l(m.namesShort, _), D = b.firstVisibleDay(o, v), k = e.first(o), y = e.last(o), x = e.toDateString, Y = new pt, C = '<table tabindex="0" role="grid" class="k-content" cellspacing="0" data-start="' + x(D) + '"><thead><tr role="row">'; 7 > n; n++)C += '<th scope="col" title="' + p[n] + '">' + w[n] + "</th>";
                    ...
                    var e = new pt(t.getFullYear(), t.getMonth() + 1, 0), n = b.firstDayOfMonth(t), a = Math.abs(e.getTimezoneOffset() - n.getTimezoneOffset());
                ...
                name: "year", title: function (t) {
                    ...
                    return a({
                        ...
                        setter: this.setDate,
                        build: function (t) {
                            return {value: e[t.getMonth()], ns: F.ns, dateString: n(t), cssClass: ""}
                        }
                    })
                }, first: function (t) {
                ...
                name: q, title: function (t, e, a) {
                    return n(t, e, a, 100)
                }, content: function (t) {
                    var e = t.date.getFullYear(), n = t.min.getFullYear(), r = t.max.getFullYear(), i = this.toDateString, o = n, s = r;
