...
!function (e, define) {
    ...
    return function (e, t) {
        function i(t, i, n) {
            return p.extend({
                init: function (e, t, i) {
                    ...
                    var t, i, n = this.widget, s = e.removedItems || n.items();
                    for (t = 0, i = s.length; i > t; t++)h(s[t], !1)
                }, _ns: function (t) {
                    t = t || k.ui;
                    var i = [k.ui, k.dataviz.ui, k.mobile.ui];
                    return i.splice(e.inArray(t, i), 1), i.unshift(t), k.rolesFromNamespaces(i)
                }, dataBound: function (e) {
                    var n, s, a, o, d = this.widget, h = e.addedItems || d.items(), l = d[i], c = k.data.HierarchicalDataSource;
                    if (!(c && l instanceof c) && h.length)for (a = e.addedDataItems || l.flatView(), o = this.bindings[t]._parents(), n = 0, s = a.length; s > n; n++)r(h[n], a[n], this._ns(e.ns), [a[n]].concat(o))
                }, refresh: function (e) {
                    var s, a, r, o = this, d = o.widget;
        ...
        function s(e) {
            var t, i, n, a, r, o, d, h = {};
            for (d = e.match(x), t = 0, i = d.length; i > t; t++)n = d[t], a = n.indexOf(":"), r = n.substring(0, a), o = n.substring(a + 1), "{" == o.charAt(0) && (o = s(o)), h[r] = o;
            return h
        }
        ...
        function r(e, t, i, o) {
            var h, l, c, u = e.getAttribute("data-" + k.ns + "role"), f = e.getAttribute("data-" + k.ns + "bind"), p = e.children, m = [], y = !0, w = {};
            if (o = o || [t], (u || f) && d(e, !1), u && (c = n(e, i)), f && (f = s(f.replace(B, "")), c || (w = k.parseOptions(e, {
                    textField: "",
                    valueField: "",
                    template: "",
                    valueUpdate: j,
                    valuePrimitive: !1,
                    autoBind: !0
                }), w.roles = i, c = new _(e, w)), c.source = t, l = a(f, o, g), w.template && (l.template = new v(o, "", w.template)), l.click && (f.events = f.events || {}, f.events.click = f.click, l.click.destroy(), delete l.click), l.source && (y = !1), f.attr && (l.attr = a(f.attr, o, g)), f.style && (l.style = a(f.style, o, g)), f.events && (l.events = a(f.events, o, b)), f.css && (l.css = a(f.css, o, g)), c.bind(l)), c && (e.kendoBindingTarget = c), y && p) {
                for (h = 0; p.length > h; h++)m[h] = p[h];
                for (h = 0; m.length > h; h++)r(m[h], t, i, o)
            }
        }

        function o(t, i) {
            var n, s, a, o = k.rolesFromNamespaces([].slice.call(arguments, 2));
            for (i = k.observable(i), t = e(t), n = 0, s = t.length; s > n; n++)a = t[n], 1 === a.nodeType && r(a, i, o)
        }

        function d(t, i) {
            var n, s = t.kendoBindingTarget;
        ...
        function l(e, t) {
            var i, n, s = e.children;
            if (s)for (i = 0, n = s.length; n > i; i++)h(s[i], t)
        }

        function c(t) {
            var i, n;
            for (t = e(t), i = 0, n = t.length; n > i; i++)h(t[i], !1)
        }
        ...
        function f(e, t) {
            ...
            if (!t)return e;
            if (e instanceof F) {
                for (i = e.length; i > a; a++)n = e[a], s[a] = n.get ? n.get(t) : n[t];
                e = s
            } else e instanceof S && (e = e.get(t));
            return e
        }

        var g, b, v, p, m, y, _, w, x, B, k = window.kendo, C = k.Observable, S = k.data.ObservableObject, F = k.data.ObservableArray, T = {}.toString, D = {}, A = k.Class, M = e.proxy, V = "value", I = "source", O = "events", H = "checked", N = "css", L = !0, P = "function", j = "change";
        !function () {
            ...
            init: function (e, t) {
                ...
                if ("this" === s.path)s.trigger(j, e); else for (t in s.dependencies)if (0 === t.indexOf(n) && (i = t.charAt(n.length), !i || "." === i || "[" === i)) {
                    s.trigger(j, e);
                    break
                }
            }, start: function (e) {
                ...
                for (e.start(e.source), a = i.get(s); a === t && i;)i = e.parents[++n], i instanceof S && (a = i.get(s));
                if (a === t)for (i = e.source; a === t && i;)i = i.parent(), i instanceof S && (a = i.get(s));
                ...
                var t = this.currentSource || this.source, i = k.getter(this.path)(t);
            ...
            get: function () {
                ...
                for (e = t.get(i); !e && t;)t = this.parents[++n], t instanceof S && (e = t.get(i));
                return M(e, t)
            }
        }), v = g.extend({
            init: function (e, t, i) {
            ...
            init: function (e, t, i) {
                ...
                var i = e(this.element), n = this.bindings.css[t], s = this.classes[t] = n.get();
            ...
            refresh: function () {
                var t = this.bindings.text.get(), i = this.element.getAttribute("data-format") || "";
            ...
            init: function (e, t, i) {
                ...
                var n, s, a, o, d = this.container(), h = d.cloneNode(!1), l = d.children[t];
                if (e(h).html(k.render(this.template(), i)), h.children.length)for (n = this.bindings.source._parents(), s = 0, a = i.length; a > s; s++)o = h.children[0], d.insertBefore(o, l || null), r(o, i[s], this.options.roles, [i[s]].concat(n))
            }, remove: function (e, t) {
                var i, n, s = this.container();
                for (i = 0; t.length > i; i++)n = s.children[e], h(n, !0), s.removeChild(n)
            }, render: function () {
                var t, i, n, s = this.bindings.source.get(), a = this.container(), o = this.template();
                if (null != s)if (s instanceof k.data.DataSource && (s = s.view()), s instanceof F || "[object Array]" === T.call(s) || (s = [s]), this.bindings.template) {
                    if (l(a, !0), e(a).html(this.bindings.template.render(s)), a.children.length)for (t = this.bindings.source._parents(), i = 0, n = s.length; n > i; i++)r(a.children[i], s[i], this.options.roles, [s[i]].concat(t))
                } else e(a).html(k.render(o, s))
            }
        }), D.input = {
            checked: m.extend({
                init: function (t, i, n) {
                    ...
                    var e, t, i, n = this.element, s = this.value();
                    if ("radio" == n.type)s = this.parsedValue(), this.bindings[H].set(s); else if ("checkbox" == n.type)if (e = this.bindings[H].get(), e instanceof F) {
                        if (s = this.parsedValue(), s instanceof Date) {
                            for (i = 0; e.length > i; i++)if (e[i] instanceof Date && +e[i] === +s) {
                                t = i;
                                break
                            }
                        } else t = e.indexOf(s);
                        t > -1 ? e.splice(t, 1) : e.push(s)
                    } else this.bindings[H].set(s)
                }, refresh: function () {
                    var e, t, i = this.bindings[H].get(), n = i, s = this.dataType(), a = this.element;
                    if ("checkbox" == a.type)if (n instanceof F) {
                        if (e = -1, i = this.parsedValue(), i instanceof Date) {
                            for (t = 0; n.length > t; t++)if (n[t] instanceof Date && +n[t] === +i) {
                                e = t;
                                break
                            }
                        } else e = n.indexOf(i);
                        a.checked = e >= 0
                    } else a.checked = n; else"radio" == a.type && null != i && ("date" == s ? i = k.toString(i, "yyyy-MM-dd") : "datetime-local" == s && (i = k.toString(i, "yyyy-MM-ddTHH:mm:ss")), a.checked = a.value === "" + i ? !0 : !1)
                }, value: function () {
            ...
            source: D.source.extend({
                refresh: function (i) {
                    var n, s = this, a = s.bindings.source.get();
                ...
                init: function (t, i, n) {
                    ...
                    var e, t, i, n, s = this.dataType(), a = [];
                    for (i = 0, n = this.element.options.length; n > i; i++)t = this.element.options[i], t.selected && (e = t.attributes.value, e = e && e.specified ? t.value : t.text, a.push(this._parseValue(e, s)));
                    return a
                }, change: function () {
                    var e, i, n, s, a, r, o, d, h = [], l = this.element, c = this.options.valueField || this.options.textField, u = this.options.valuePrimitive;
                    for (a = 0, r = l.options.length; r > a; a++)i = l.options[a], i.selected && (s = i.attributes.value, s = s && s.specified ? i.value : i.text, h.push(this._parseValue(s, this.dataType())));
                    if (c)for (e = this.bindings.source.get(), e instanceof k.data.DataSource && (e = e.view()), n = 0; h.length > n; n++)for (a = 0, r = e.length; r > a; a++)if (o = this._parseValue(e[a].get(c), this.dataType()), d = o + "" === h[n]) {
                        h[n] = e[a];
                        break
                    }
                    ...
                    var e, t, i, n = this.element, s = n.options, a = this.bindings[V].get(), r = a, o = this.options.valueField || this.options.textField, d = !1, h = this.dataType();
                    for (r instanceof F || (r = new F([a])), n.selectedIndex = -1, i = 0; r.length > i; i++)for (a = r[i], o && a instanceof S && (a = a.get(o)), "date" == h ? a = k.toString(r[i], "yyyy-MM-dd") : "datetime-local" == h && (a = k.toString(r[i], "yyyy-MM-ddTHH:mm:ss")), e = 0; s.length > e; e++)t = s[e].value, "" === t && "" !== a && (t = s[e].text), null != a && t == "" + a && (s[e].selected = !0, d = !0)
                }, destroy: function () {
                    e(this.element).off(j, this._change)
                }
            })
            ...
            value: p.extend({
                init: function (t, i, n) {
                    ...
                    var e, t, i, n, s, a, r, o = this.widget.value(), d = this.options.dataValueField || this.options.dataTextField, h = "[object Array]" === T.call(o), l = this._valueIsObservableObject, c = [];
                    if (this._initChange = !0, d)if ("" === o && (l || this.options.valuePrimitive))o = null; else {
                        for (r = this._source(), h && (t = o.length, c = o.slice(0)), s = 0, a = r.length; a > s; s++)if (i = r[s], n = i.get(d), h) {
                    ...
                    var e, i, n, s, a, r, o, d, h;
                    if (!this._initChange) {
                        if (e = this.widget, i = e.options, n = i.dataTextField, s = i.dataValueField || n, a = this.bindings.value.get(), r = i.text || "", o = 0, h = [], a === t && (a = null), s)if (a instanceof F) {
                            for (d = a.length; d > o; o++)h[o] = a[o].get(s);
                            a = h
                        } else a instanceof S && (r = a.get(n), a = a.get(s));
            ...
            multiselect: {
                value: p.extend({
                    init: function (t, i, n) {
                        ...
                        var e, i, n, s, a, r, o, d, h, l = this, c = l.bindings[V].get(), u = l.options.valuePrimitive, f = u ? l.widget.value() : l.widget.dataItems(), g = this.options.dataValueField || this.options.dataTextField;
                        if (f = f.slice(0), l._initChange = !0, c instanceof F) {
                            for (e = [], i = f.length, n = 0, s = 0, a = c[n], r = !1; a !== t;) {
                                for (h = !1, s = 0; i > s; s++)if (u ? r = f[s] == a : (d = f[s], d = d.get ? d.get(g) : d, r = d == (a.get ? a.get(g) : a)), r) {
                            ...
                            y(c, c.length, 0, f), e.length && c.trigger("change", {
                                ...
                                items: e,
                                index: o
                            }), f.length && c.trigger("change", {action: "add", items: f, index: c.length - 1})
                        } else l.bindings[V].set(f);
                        l._initChange = !1
                    }, refresh: function () {
                        if (!this._initChange) {
                            var e, i, n = this.options, s = this.widget, a = n.dataValueField || n.dataTextField, r = this.bindings.value.get(), o = r, d = 0, h = [];
                            if (r === t && (r = null), a)if (r instanceof F) {
                                for (e = r.length; e > d; d++)i = r[d], h[d] = i.get ? i.get(a) : i;
                                r = h
            ...
            scheduler: {
                source: i("source", "dataSource", "setDataSource").extend({
                    dataBound: function (e) {
                        var t, i, n, s, a = this.widget, o = e.addedItems || a.items();
                        if (o.length)for (n = e.addedDataItems || a.dataItems(), s = this.bindings.source._parents(), t = 0, i = n.length; i > t; t++)r(o[t], n[t], this._ns(e.ns), [n[t]].concat(s))
                    }
                })
            }
        }, y = function (e, t, i, n) {
            ...
            if (n = n || [], i = i || 0, s = n.length, a = e.length, r = [].slice.call(e, t + i), o = r.length, s) {
                for (s = t + s, d = 0; s > t; t++)e[t] = n[d], d++;
                e.length = s
            } else if (i)for (e.length = t, i += t; i > t;)delete e[--i];
            if (o) {
                for (o = t + o, d = 0; o > t; t++)e[t] = r[d], d++;
                e.length = o
            }
            for (t = e.length; a > t;)delete e[t], t++
        }, _ = A.extend({
            init: function (e, t) {
                this.target = e, this.options = t, this.toDestroy = []
            }, bind: function (e) {
                var t, i, n, s, a, r, o = this instanceof w, d = this.binders();
                for (t in e)t == V ? i = !0 : t == I ? n = !0 : t != O || o ? t == H ? a = !0 : t == N ? r = !0 : this.applyBinding(t, e, d) : s = !0;
                ...
                var n, s = i[e] || D[e], a = this.toDestroy, r = t[e];
                if (s)if (s = new s(this.target, t, this.options), a.push(s), r instanceof g)s.bind(r), a.push(r); else for (n in r)s.bind(r, n), a.push(r[n]); else if ("template" !== e)throw Error("The " + e + " binding is not supported by the " + this.target.nodeName.toLowerCase() + " element")
            }, destroy: function () {
            ...
            binders: function () {
                ...
                var n, s = i[e] || D.widget[e], a = this.toDestroy, r = t[e];
                if (!s)throw Error("The " + e + " binding is not supported by the " + this.target.options.name + " widget");
                if (s = new s(this.target, t, this.target.options), a.push(s), r instanceof g)s.bind(r), a.push(r); else for (n in r)s.bind(r, n), a.push(r[n])
            }
            ...
            function t(e) {
                var i, n;
                for (i = 0; e.length > i; i++)e[i]._initChildren(), n = e[i].children, n.fetch(), e[i].items = n.data(), t(e[i].items)
            }
