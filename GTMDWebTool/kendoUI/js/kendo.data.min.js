...
!function (e, define) {
    ...
    return function (e, t) {
        ...
        function o(e) {
            ...
            if (a)for (t = 0, r = a.length; r > t; t++)n = a[t], i = n.operator, i && typeof i === we && (n.operator = X[i.toLowerCase()] || i), o(n)
        }

        function u(e) {
            return e && !fe(e) ? ((ce(e) || !e.filters) && (e = {logic: "and", filters: ce(e) ? e : [e]}), o(e), e) : t
        }
        ...
        function f(e, t) {
            ...
            for (i = i.sort(h), a = a.sort(h), s = 0; i.length > s; s++)if (r = i[s], n = a[s], r.logic && n.logic) {
                if (!f(r, n))return !1
        ...
        function _(e, t, r, n, i, a) {
            var s, o, u, l, d;
            for (t = t || [], l = t.length, s = 0; l > s; s++)o = t[s], u = o.aggregate, d = o.field, e[d] = e[d] || {}, a[d] = a[d] || {}, a[d][u] = a[d][u] || {}, e[d][u] = Y[u.toLowerCase()](e[d][u], r, me.accessor(d), n, i, a[d][u])
        }
        ...
        function w(e, t, r, n, i) {
            var a, s, o, u;
            for (s = 0, u = e.length; u > s; s++)a = e[s], o = n[a.field], o && o != a.field && (a.field = o), a.value = r._parse(a.field, a.value), a.hasSubgroups ? w(a.items, t, r, n, i) : b(a.items, t, r, n, i)
        }
        ...
        function q(e) {
            var t, r, n, i, a, s = [];
            for (t = 0, r = e.length; r > t; t++)if (a = e.at(t), a.hasSubgroups)s = s.concat(q(a.items)); else for (n = a.items, i = 0; n.length > i; i++)s.push(n.at(i));
            return s
        }

        function D(e, t) {
            var r, n, i;
            if (t)for (r = 0, n = e.length; n > r; r++)i = e.at(r), i.hasSubgroups ? D(i.items, t) : i.items = new U(i.items, t)
        }

        function C(e, t) {
            for (var r = 0, n = e.length; n > r; r++)if (e[r].hasSubgroups) {
        ...
        function R(e, r, n, i, a) {
            var s, o, u, l;
            for (s = 0, o = e.length; o > s; s++)if (u = e[s], u && !(u instanceof i))if (u.hasSubgroups === t || a) {
                for (l = 0; r.length > l; l++)if (r[l] === u) {
        ...
        function P(e, t) {
            var r, n, i;
            for (r = 0, n = e.length; n > r; r++)if (i = e.at(r), i.uid == t.uid)return e.splice(r, 1), i
        }
        ...
        function N(e, t) {
            ...
            if (e.filters)for (a.filters = [], r = 0, n = e.filters.length; n > r; r++)a.filters[r] = N(e.filters[r], t); else a.field = I(t.fields, a.field);
            return a
        }
        ...
        function j(t, r) {
            ...
            for (t = e(t)[0], n = t.options, i = r[0], a = r[1], s = [], o = 0, u = n.length; u > o; o++)h = {}, d = n[o], l = d.parentNode, l === t && (l = null), d.disabled || l && l.disabled || (l && (h.optgroup = l.label), h[i.field] = d.text, f = d.attributes.value, f = f && f.specified ? d.value : d.text, h[a.field] = f, s.push(h));
            return s
        }

        function L(t, r) {
            var n, i, a, s, o, u, l, d = e(t)[0].tBodies[0], h = d ? d.rows : [], f = r.length, c = [];
            for (n = 0, i = h.length; i > n; n++) {
                for (o = {}, l = !0, s = h[n].cells, a = 0; f > a; a++)u = s[a], "th" !== u.nodeName.toLowerCase() && (l = !1, o[r[a].field] = u.innerHTML);
                l || c.push(o)
            }
            return c
        }
        ...
        function G(e) {
            return function () {
                var t = this._data, r = ne.fn[e].apply(this, Je.call(arguments));
        ...
        function E(t, r) {
            ...
            var i, a, s, o, u, l, d, h, f = e(t).children(), c = [], g = r[0].field, p = r[1] && r[1].field, _ = r[2] && r[2].field, v = r[3] && r[3].field;
            for (i = 0, a = f.length; a > i; i++)s = {_loaded: !0}, o = f.eq(i), l = o[0].firstChild, h = o.children(), t = h.filter("ul"), h = h.filter(":not(ul)"), u = o.attr("data-id"), u && (s.id = u), l && (s[g] = 3 == l.nodeType ? l.nodeValue : h.text()), p && (s[p] = n(h, "a").attr("href")), v && (s[v] = n(h, "img").attr("src")), _ && (d = n(h, ".k-sprite").prop("className"), s[_] = d && e.trim(d.replace("k-sprite", ""))), t.length && (s.items = E(t.eq(0), r)), "true" == o.attr("data-hasChildren") && (s.hasChildren = !0), c.push(s);
            return c
        }

        var B, U, H, J, V, W, Q, K, $, X, Y, Z, ee, te, re, ne, ie, ae, se, oe, ue, le = e.extend, de = e.proxy, he = e.isPlainObject, fe = e.isEmptyObject, ce = e.isArray, ge = e.grep, pe = e.ajax, _e = e.each, ve = e.noop, me = window.kendo, ye = me.isFunction, Se = me.Observable, be = me.Class, we = "string", ke = "function", xe = "create", qe = "read", De = "update", Ce = "destroy", Oe = "change", ze = "sync", Re = "get", Pe = "error", Te = "requestStart", Fe = "progress", Ae = "requestEnd", Ie = [xe, qe, De, Ce], Ne = function (e) {
            return e
        }, Me = me.getter, je = me.stringify, Le = Math, Ge = [].push, Ee = [].join, Be = [].pop, Ue = [].splice, He = [].shift, Je = [].slice, Ve = [].unshift, We = {}.toString, Qe = me.support.stableSort, Ke = /^\/Date\((.*?)\)\/$/, $e = /(\r+|\n+)/g, Xe = /(?=['\\])/g, Ye = Se.extend({
            init: function (e, t) {
                var r = this;
                ...
                for (e = 0; r > e; e++)t = this[e], t instanceof H && (t = t.toJSON()), n[e] = t;
                return n
                ...
                return e = Ge.apply(this, r), this.trigger(Oe, {action: "add", index: t, items: r}), e
            }, slice: Je, sort: [].sort, join: Ee, pop: function () {
                var e = this.length, t = Be.apply(this);
                return e && this.trigger(Oe, {action: "remove", index: e - 1, items: [t]}), t
            }, splice: function (e, t, r) {
                var n, i, a, s = this.wrapAll(Je.call(arguments, 2));
                if (n = Ue.apply(this, [e, t].concat(s)), n.length)for (this.trigger(Oe, {
                    action: "remove",
                    index: e,
                    items: n
                }), i = 0, a = n.length; a > i; i++)n[i] && n[i].children && n[i].unbind(Oe);
                return r && this.trigger(Oe, {action: "add", index: e, items: s}), n
            }, shift: function () {
                var e = this.length, t = He.apply(this);
                return e && this.trigger(Oe, {action: "remove", index: 0, items: [t]}), t
            }, unshift: function () {
                var e, t = this.wrapAll(arguments);
                return e = Ve.apply(this, t), this.trigger(Oe, {action: "add", index: 0, items: t}), e
            }, indexOf: function (e) {
                var t, r, n = this;
                ...
                var t, r = 0, n = this.length;
                for (2 == arguments.length ? t = arguments[1] : n > r && (t = this[r++]); n > r; r++)t = e(t, this[r], r, this);
                return t
        ...
        "undefined" != typeof Symbol && Symbol.iterator && !Ye.prototype[Symbol.iterator] && (Ye.prototype[Symbol.iterator] = [][Symbol.iterator]), U = Ye.extend({
            init: function (e, t) {
                ...
                for (var r = 0; e.length > r; r++)this[r] = e[r];
            ...
            init: function (e) {
                ...
                var r = this, n = !1, i = e.indexOf(".") >= 0, a = me.getter(e, !0)(r);
            ...
            }, parent: ve, wrap: function (e, t, n) {
                var i, a, s, o, u = this, l = We.call(e);
        ...
        }, V = {string: "", number: 0, date: new Date, "boolean": !1, "default": ""}, W = H.extend({
            init: function (r) {
                var n, i, a = this;
                if ((!r || e.isEmptyObject(r)) && (r = e.extend({}, a.defaults, r), a._initializers))for (n = 0; a._initializers.length > n; n++)i = a._initializers[n], r[i] = a.defaults[i]();
            ...
            r === t && (r = e, e = W);
            var n, i, a, s, o, u, l, d, h = le({defaults: {}}, r), f = {}, c = h.id, g = [];
            if (c && (h.idField = c), h.id && delete h.id, c && (h.defaults[c] = h._defaultId = ""), "[object Array]" === We.call(h.fields)) {
                for (u = 0, l = h.fields.length; l > u; u++)a = h.fields[u], typeof a === we ? f[a] = {} : a.field && (f[a.field] = a);
                h.fields = f
            }
            ...
            var r, n, i, s, o, u, l = [], d = {and: " && ", or: " || "}, h = [], f = [], c = e.filters;
            for (r = 0, n = c.length; n > r; r++)i = c[r], o = i.field, u = i.operator, i.filters ? (s = a.filterExpr(i), i = s.expression.replace(/__o\[(\d+)\]/g, function (e, t) {
            ...
            toArray: function () {
                ...
                var t, r, n, i, s, o, l, d, h = this.data, f = [];
                ...
                for (i = a.filterExpr(e), o = i.fields, l = i.operators, s = d = Function("d, __f, __o", "return " + i.expression), (o.length || l.length) && (d = function (e) {
                    return s(e, o, l)
                }), t = 0, n = h.length; n > t; t++)r = h[t], d(r) && f.push(r);
                return new a(f)
            }, group: function (e, t) {
                e = g(e || []), t = t || this.data;
                var r, n = this, i = new a(n.data);
                return e.length > 0 && (r = e[0], i = i.groupBy(r).select(function (n) {
                    var i = new a(t).filter([{field: n.field, operator: "eq", value: n.value, ignoreCase: !1}]);
                    return {
                        field: n.field,
                        value: n.value,
                ...
                var t, r, n, i, s = e.field, o = this._sortForGrouping(s, e.dir || "asc"), u = me.accessor(s), l = u.get(o[0], s), d = {
                    field: s,
                    value: l,
                    items: []
                }, h = [d];
                for (n = 0, i = o.length; i > n; n++)t = o[n], r = u.get(t, s), p(l, r) || (l = r, d = {
                    field: s,
                    value: l,
                    items: []
                ...
                if (!Qe) {
                    ...
                    for (i = new a(i).sort(e, t, K).toArray(), r = 0, n = i.length; n > r; r++)delete i[r].__position;
                    return i
                }
                return this.sort(e, t).toArray()
            }, aggregate: function (e) {
                var t, r, n = {}, i = {};
                if (e && e.length)for (t = 0, r = this.data.length; r > t; t++)_(n, e, this.data[t], t, r, i);
                return n
            }
        }, Y = {
            sum: function (e, t, r) {
            ...
            r = r || {};
            var n, i = new a(e), o = r.group, u = g(o || []).concat(s(r.sort || [])), l = r.filterCallback, d = r.filter, h = r.skip, f = r.take;
            ...
            init: function (e) {
            ...
            }, options: {parameterMap: Ne}, create: function (e) {
                ...
                e = e || {};
                var r, n = this, i = n.options[t], a = ye(i.data) ? i.data(e.data) : i.data;
            ...
            }, parse: Ne, data: Ne, total: function (e) {
                return e.length
            }, groups: Ne, aggregates: function () {
                return {}
            ...
            _flatData: function (e, t) {
                if (e) {
                    ...
                    if (!t)for (var r = 0; e.length > r; r++)e.at(r)
                }
                return e
            },
            parent: ve,
            ...
            data: function (e) {
                var r, n = this;
                if (e === t) {
                    if (n._data)for (r = 0; n._data.length > r; r++)n._data.at(r);
                    return n._data
                }
            ...
            pushCreate: function (e) {
                ...
                try {
                    for (n = 0; e.length > n; n++)i = e[n], a = this.add(i), t.push(a), s = a.toJSON(), this._isServerGrouped() && (s = this._wrapInEmptyGroup(s)), this._pristineData.push(s)
                } finally {
            ...
            pushUpdate: function (e) {
                var t, r, n, i, a;
                for (ce(e) || (e = [e]), t = [], r = 0; e.length > r; r++)n = e[r], i = this._createNewModel(n), a = this.get(i.id), a ? (t.push(a), a.accept(n), a.trigger(Oe), this._updatePristineForModel(a, n)) : this.pushCreate(n);
            ...
            _removeItems: function (e) {
                ...
                ce(e) || (e = [e]), t = [], r = this.options.autoSync, this.options.autoSync = !1;
                try {
                    for (n = 0; e.length > n; n++)i = e[n], a = this._createNewModel(i), s = !1, this._eachItem(this._data, function (e) {
                        var r, n;
                        for (r = 0; e.length > r; r++)if (n = e.at(r), n.id === a.id) {
            ...
            created: function () {
                var e, t, r = [], n = this._flatData(this._data);
                for (e = 0, t = n.length; t > e; e++)n[e].isNew && n[e].isNew() && r.push(n[e]);
                return r
            },
            updated: function () {
                var e, t, r = [], n = this._flatData(this._data);
                for (e = 0, t = n.length; t > e; e++)n[e].isNew && !n[e].isNew() && n[e].dirty && r.push(n[e]);
                return r
            },
            sync: function () {
                var t, r = this, n = [], i = [], a = r._destroyed, s = e.Deferred().resolve().promise();
                if (r.online()) {
                ...
                } else r._storeData(!0), r._change({action: "sync"});
                return s
            },
            ...
            _markOfflineUpdatesAsDirty: function () {
                ...
                null != e.options.offlineStorage && e._eachItem(e._data, function (e) {
                    var t, r;
                    for (t = 0; e.length > t; t++)r = e.at(t), ("update" == r.__state__ || "create" == r.__state__) && (r.dirty = !0)
                })
            },
            hasChanges: function () {
                var e, t, r = this._flatData(this._data);
                if (this._destroyed.length)return !0;
                for (e = 0, t = r.length; t > e; e++)if (r[e].isNew && r[e].isNew() || r[e].dirty)return !0;
                return !1
            },
            _accept: function (t) {
                var r, n = this, i = t.models, a = t.response, s = 0, o = n._isServerGrouped(), u = n._pristineData, l = t.type;
                if (n.trigger(Ae, {response: a, type: l}), a && !fe(a)) {
                    if (a = n.reader.parse(a), n._handleCustomErrors(a))return;
                    a = n.reader.data(a), ce(a) || (a = [a])
                } else a = e.map(i, function (e) {
                    return e.toJSON()
                });
                for ("destroy" === l && (n._destroyed = []), s = 0, r = i.length; r > s; s++)"destroy" !== l ? (i[s].accept(a[s]), "create" === l ? u.push(o ? n._wrapInEmptyGroup(i[s]) : a[s]) : "update" === l && n._updatePristineForModel(i[s], a[s])) : n._removePristineForModel(i[s])
            },
            ...
            _submit: function (t, r) {
                ...
                n.trigger(Te, {type: "submit"}), n.transport.submit(le({
                    success: function (r, n) {
                        ...
                        i && i.resolve({response: r, models: i.models, type: n})
                    }, error: function (e, r, i) {
                        for (var a = 0; t.length > a; a++)t[a].reject(e);
                        n.error(e, r, i)
                    }
                }, r))
            },
            ...
            _send: function (e, t) {
                var r, n, i = this, a = [], s = i.reader.serialize(y(t));
            ...
            success: function (e) {
                var r, n, i, a, s, o, u, l, d = this, h = d.options;
                if (d.trigger(Ae, {response: e, type: "read"}), d.online()) {
                    ...
                    for (e = d._readData(e), r = [], n = {}, i = d.reader.model, a = i ? i.idField : "id", s = 0; this._destroyed.length > s; s++)o = this._destroyed[s][a], n[o] = o;
                    for (s = 0; e.length > s; s++)u = e[s], l = u.__state__, "destroy" == l ? n[u[a]] || this._destroyed.push(this._createNewModel(u)) : r.push(u);
            ...
            _storeData: function (e) {
                function t(e) {
                    var r, n, i, a = [];
                    for (r = 0; e.length > r; r++)n = e.at(r), i = n.toJSON(), s && n.items ? i.items = t(n.items) : (i.uid = n.uid, o && (n.isNew() ? i.__state__ = "create" : n.dirty && (i.__state__ = "update"))), a.push(i);
                    return a
                }

                var r, n, i, a, s = this._isServerGrouped(), o = this.reader.model;
                if (null != this.options.offlineStorage) {
                    for (r = t(this._data), n = [], i = 0; this._destroyed.length > i; i++)a = this._destroyed[i].toJSON(), a.__state__ = "destroy", n.push(a);
                    this.offlineData(r.concat(n)), e && (this._pristineData = this._readData(r))
                }
            },
            _addRange: function (e) {
                var t = this, r = t._skip || 0, n = r + t._flatData(e, !0).length;
                t._ranges.push({
                    start: r,
                    end: n,
                    data: e,
            ...
            _updateTotalForAction: function (e, t) {
                var r = this, n = parseInt(r._total, 10);
            ...
            filter: function (e) {
                var r = this;
                return e === t ? r._filter : (r.trigger("reset"), r._query({filter: e, page: 1}), t)
            },
            group: function (e) {
                var r = this;
            ...
            _emptyAggregates: function (e) {
                var t, r, n = {};
                if (!fe(e))for (t = {}, ce(e) || (e = [e]), r = 0; e.length > r; r++)t[e[r].aggregate] = 0, n[e[r].field] = t;
                return n
            },
            ...
            inRange: function (e, t) {
                var r = this, n = Le.min(e + t, r.total());
            ...
            range: function (e, r) {
                ...
                } else r !== t && (n._rangeExists(i, a) ? e > i && n.prefetch(a, r, function () {
                    n.range(e, r)
            ...
            _findRange: function (e, r) {
                var n, i, a, o, u, l, d, h, f, c, p, _, v = this, m = v._ranges, y = [], S = v.options, b = S.serverSorting || S.serverPaging || S.serverFiltering || S.serverGrouping || S.serverAggregates;
                for (i = 0, p = m.length; p > i; i++)if (n = m[i], e >= n.start && n.end >= e) {
                    for (c = 0, a = i; p > a; a++)if (n = m[a], f = v._flatData(n.data, !0), f.length && e + c >= n.start && (l = n.data, d = n.end, b || (_ = g(v.group() || []).concat(s(v.sort() || [])), h = v._queryProcess(n.data, {
                            sort: _,
                            filter: v.filter()
                        }), f = l = h.data, h.total !== t && (d = h.total)), o = 0, e + c > n.start && (o = e + c - n.start), u = f.length, d > r && (u -= d - r), c += u - o, y = v._mergeGroups(y, l, o, u), n.end >= r && c == r - e))return y;
                    break
                }
                return []
            },
            ...
            _prefetchSuccessHandler: function (e, t, r, n) {
                var i = this, a = i._timeStamp();
                return function (s) {
                    var o, u, l, d = !1, h = {start: e, end: t, data: [], timestamp: i._timeStamp()};
                    if (i._dequeueRequest(), i.trigger(Ae, {
                            response: s,
                            type: "read"
                        }), s = i.reader.parse(s), l = i._readData(s), l.length) {
                        for (o = 0, u = i._ranges.length; u > o; o++)if (i._ranges[o].start === e) {
                            d = !0, h = i._ranges[o];
                            break
                        }
                        d || i._ranges.push(h)
            ...
            prefetch: function (e, t, r) {
                var n = this, i = Le.min(e + t, n.total()), a = {
                    take: t,
                    skip: e,
                    page: e / t + 1,
                    pageSize: t,
            ...
            _updateRangesLength: function () {
                var e, t, r, n, i = 0;
                for (r = 0, n = this._ranges.length; n > r; r++)e = this._ranges[r], e.start = e.start - i, t = this._flatData(e.data, !0).length, i = e.end - t, e.end = e.start + t
            }
            ...
            var r, n, i, a = e || {}, s = a.data, o = a.fields, u = a.table, l = a.select, d = {};
            if (s || !o || a.transport || (u ? s = L(u, o) : l && (s = j(l, o), a.group === t && s[0] && s[0].optgroup !== t && (a.group = "optgroup"))), me.data.Model && o && (!a.schema || !a.schema.model)) {
                for (r = 0, n = o.length; n > r; r++)i = o[r], i.type && (d[i.field] = i);
            ...
            idField: "id", init: function (e) {
                ...
                me.data.Model.fn.init.call(t, e), typeof t.children === we && (n = t.children), i = {
                    schema: {
                        data: n,
                        model: {hasChildren: r, id: t.idField, fields: t.fields}
                    }
            ...
            init: function (e) {
                ...
                ne.fn.init.call(this, le(!0, {}, {schema: {modelBase: t, model: t}}, e)), this._attachBubbleHandlers()
            ...
            }, success: G("success"), data: G("data"), insert: function (e, t) {
                var r = this.parent();
                ...
                if (s) {
                    ...
                    for (s = this._flatData(this._data), r = 0, n = s.length; n > r; r++)if (a = s[r].children, a instanceof se && (i = a[e](t)))return i
                }
            }, get: function (e) {
            ...
            init: function (e, t, r) {
                ...
                var e = this, t = e.pageSize, r = e.skip - e.viewSize + t, n = Le.max(Le.floor(r / t), 0) * t;
                this.offset = r, this.dataSource.prefetch(n, t, function () {
                    e._goToRange(r, !0)
                })
            }, range: function (e, t) {
                if (this.offset === e)return !0;
                var r = this, n = this.pageSize, i = Le.max(Le.floor(e / n), 0) * n, a = this.dataSource;
            ...
            init: function (e, t) {
                ...
                var t, r, n = this.buffer, i = e * this.batchSize, a = this.batchSize, s = [];
                for (n.offset > i && n.at(n.offset - 1), r = 0; a > r && (t = n.at(i + r), null !== t); r++)s.push(t);
                return s
            }, total: function () {
                return this._total
            }, destroy: function () {
