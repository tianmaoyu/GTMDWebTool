 ...
 */
!function (t, define) {
    define("kendo.router.min", ["kendo.core.min"], t)
}(function () {
    return function (t, n) {
        function e(t, n) {
            if (!n)return t;
        ...
        var h = window.kendo, u = "change", c = "back", l = "same", f = h.support, d = window.location, p = window.history, g = 50, b = h.support.browser.msie, k = /^#*/, w = window.document, v = h.Class.extend({
            back: function () {
            ...
            init: function (t) {
                ...
                var n, o = t.root, a = d.pathname, s = i(r(t.hashBang));
            ...
            start: function (n) {
                ...
                var t = this.adapter, e = t.current(), r = t.length(), i = this.historyLength === r, o = e === this.locations[this.locations.length - 2] && i, a = this.backCalled, s = this.current;
        ...
        var r = window.kendo, i = r.history, o = r.Observable, a = "init", s = "routeMissing", h = "change", u = "back", c = "same", l = /\((.*?)\)/g, f = /(\(\?)?:\w+/g, d = /\*\w+/g, p = /[\-{}\[\]+?.,\\\^$|#\s]/g, g = r.Class.extend({
            init: function (t, e, r) {
                t instanceof RegExp || (t = n(t, r)), this.route = t, this._callback = e
            }, callback: function (t, n) {
                var i, o, a = 0, s = r.parseQueryStringParams(t);
                for (s._back = n, t = e(t), i = this.route.exec(t).slice(1), o = i.length; o > a; a++)void 0 !== i[a] && (i[a] = decodeURIComponent(i[a]));
            ...
            init: function (t) {
                ...
                this.trigger(u, {url: t.url, to: t.to}) && t.preventDefault()
            }, _same: function () {
                this.trigger(c)
            }, _urlChanged: function (t) {
                var n, e, i, o, a = t.url, u = t.backButtonPressed;
                if (a || (a = "/"), this.trigger(h, {
                        url: t.url,
                        params: r.parseQueryStringParams(t.url),
                        backButtonPressed: u
                    }))return void t.preventDefault();
                for (n = 0, e = this.routes, o = e.length; o > n; n++)if (i = e[n], i.worksWith(a, u))return;
                this.trigger(s, {
                    url: a,
