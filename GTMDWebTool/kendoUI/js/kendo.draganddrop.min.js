...
!function (t, define) {
    ...
    return function (t, e) {
        ...
        function o(t, e) {
            var n = D(t), i = n.left + r(t, "borderLeftWidth") + r(t, "paddingLeft"), o = n.top + r(t, "borderTopWidth") + r(t, "paddingTop"), a = i + t.width() - e.outerWidth(!0), s = o + t.height() - e.outerHeight(!0);
            return {x: {min: i, max: a}, y: {min: o, max: s}}
        }

        function a(n, r, i) {
            for (var o, a, s = 0, l = r && r.length, c = i && i.length; n && n.parentNode;) {
                for (s = 0; l > s; s++)if (o = r[s], o.element[0] === n)return {target: o, targetElement: n};
                for (s = 0; c > s; s++)if (a = i[s], t.contains(a.element[0], n) && x.matchesSelector.call(n, a.options.filter))return {
                    target: a,
                    targetElement: n
                };
                n = n.parentNode
        ...
        function s(t, e) {
            var n, r = e.options.group, i = t[r];
            if (T.fn.destroy.call(e), i.length > 1) {
                for (n = 0; i.length > n; n++)if (i[n] == e) {
                    i.splice(n, 1);
                    break
                }
        ...
        function h(t, e, n) {
            var r = {x: 0, y: 0}, i = 50;
            return i > t - n.left ? r.x = -(i - (t - n.left)) : i > n.right - t && (r.x = i - (n.right - t)), i > e - n.top ? r.y = -(i - (e - n.top)) : i > n.bottom - e && (r.y = i - (n.bottom - e)), r
        }

        var d, f, p, g, v, m, _ = window.kendo, x = _.support, y = window.document, b = t(window), E = _.Class, T = _.ui.Widget, M = _.Observable, S = _.UserEvents, w = t.proxy, C = t.extend, D = _.getOffset, O = {}, k = {}, I = {}, H = _.elementUnderCursor, W = "keyup", z = "change", P = "dragstart", U = "hold", L = "drag", A = "dragend", N = "dragcancel", V = "hintDestroyed", B = "dragenter", $ = "dragleave", F = "drop", j = M.extend({
            init: function (e, n) {
                var r = this, i = e[0];
                ...
                })), M.fn.init.call(r), r.bind(["press", "release"], n || {})
            ...
            init: function (e) {
                var n = this;
                M.fn.init.call(n), n.forcedEnabled = !1, t.extend(n, e), n.scale = 1, n.horizontal ? (n.measure = "offsetWidth", n.scrollSize = "scrollWidth", n.axis = "x") : (n.measure = "offsetHeight", n.scrollSize = "scrollHeight", n.axis = "y")
                ...
                var e = this, n = e.virtual ? e._virtualMax : e.getTotal(), r = n * e.scale, i = e.getSize();
            ...
            init: function (t) {
                var e = this;
                M.fn.init.call(e), e.x = new G(C({horizontal: !0}, t)), e.y = new G(C({horizontal: !1}, t)), e.container = t.container, e.forcedMinScale = t.minScale, e.maxScale = t.maxScale || 100, e.bind(z, t)
            }, rescale: function (t) {
            ...
            init: function (t) {
                var e = this;
                C(e, t), M.fn.init.call(e)
            }, outOfBounds: function () {
                return this.dimension.outOfBounds(this.movable[this.axis])
            }, dragMove: function (t) {
                var e = this, n = e.dimension, r = e.axis, i = e.movable, o = i[r] + t;
                n.enabled && ((n.min > o && 0 > t || o > n.max && t > 0) && (t *= e.resistance), i.translateAxis(r, t), e.trigger(z, e))
            }
        }), J = E.extend({
            init: function (e) {
                var n, r, i, o, a = this;
                C(a, {elastic: !0}, e), i = a.elastic ? .5 : 0, o = a.movable, a.x = n = new q({
                    axis: "x",
                    ...
                    gesturestart: function (t) {
                        ...
                        var e, i, s, l = a.gesture, c = l.center, u = t.center, h = t.distance / l.distance, d = a.dimensions.minScale, f = a.dimensions.maxScale;
                        d >= o.scale && 1 > h && (h += .8 * (1 - h)), o.scale * h >= f && (h = f / o.scale), i = o.x + a.offset.left, s = o.y + a.offset.top, e = {
                            x: (i - c.x) * h + u.x - i,
                            y: (s - c.y) * h + u.y - s
        ...
        f = x.hasHW3D ? function (t, e, n) {
            ...
            init: function (e) {
                var n = this;
                M.fn.init.call(n), n.element = t(e), n.element[0].style.webkitTransformOrigin = "left top", n.x = 0, n.y = 0, n.scale = 1, n._saveCoordinates(f(n.x, n.y, n.scale))
                ...
                var t, e = this, n = e.x, r = e.y;
                e.round && (n = Math.round(n), r = Math.round(r)), t = f(n, r, e.scale), t != e.coordinates && (_.support.browser.msie && 10 > _.support.browser.version ? (e.element[0].style.position = "absolute", e.element[0].style.left = e.x + "px", e.element[0].style.top = e.y + "px") : e.element[0].style[K] = t, e._saveCoordinates(t), e.trigger(z))
            ...
            }, events: [B, $, F], options: {name: "DropTarget", group: "default"}, destroy: function () {
                s(k, this)
            }, _trigger: function (t, n) {
                var r = this, i = O[r.options.group];
                return i ? r.trigger(t, C({}, n.event, {draggable: i, dropTarget: n.dropTarget})) : e
            }, _over: function (t) {
                this._trigger(B, t)
            }, _out: function (t) {
                this._trigger($, t)
            }, _drop: function (t) {
                var e = this, n = O[e.options.group];
                n && (n.dropped = !e._trigger(F, t))
            }
        }), g.destroyGroup = function (t) {
            var e, n = k[t] || I[t];
            if (n) {
                for (e = 0; n.length > e; e++)T.fn.destroy.call(n[e]);
            ...
            init: function (t, e) {
                var n = this;
                T.fn.init.call(n, t, e), n._activated = !1, n.userEvents = new S(n.element, {
                    global: !0,
                    allowSelection: !0,
            ...
            _captureEscape: function (t) {
                var e = this;
                t.keyCode === _.keys.ESC && (e._trigger(N, {event: t}), e.userEvents.cancel())
            },
            _updateHint: function (e) {
                var n, r = this, o = r.options, a = r.boundaries, s = o.axis, l = r.options.cursorOffset;
                l ? n = {
            ...
            _start: function (n) {
                var r, i = this, a = i.options, s = a.container, l = a.hint;
            ...
            _processMovement: function (n, r) {
                this._withDropTarget(r, function (r, i) {
                    if (!r)return d && (d._trigger($, C(n, {dropTarget: t(d.targetElement)})), d = null), e;
                    if (d) {
            ...
            _autoScroll: function () {
                var t, e, n, r, i, o, a, s, l = this._scrollableParent[0], u = this._scrollVelocity, h = this._scrollCompenstation;
                l && (t = this._elementUnderCursor(this._lastEvent), this._processMovement(this._lastEvent, t), r = l === c()[0], r ? (e = y.body.scrollHeight > b.height(), n = y.body.scrollWidth > b.width()) : (e = l.scrollHeight >= l.offsetHeight, n = l.scrollWidth >= l.offsetWidth), i = l.scrollTop + u.y, o = e && i > 0 && l.scrollHeight > i, a = l.scrollLeft + u.x, s = n && a > 0 && l.scrollWidth > a, o && (l.scrollTop += u.y), s && (l.scrollLeft += u.x), r && (s || o) && (o && (h.top += u.y), s && (h.left += u.x), this.hint.css(h)))
            },
            _end: function (e) {
            ...
            PaneDimensions: Q,
            Movable: p
        }), _.ui.Draggable.utils = {autoScrollVelocity: h, scrollableViewPort: l, findScrollableParent: u}
